public class STFMP_Request {
    ...
    public STFMP_Request(String protocolVersion, String action, String params){
    ...
    public static STFMP_Request fromEncryptedString(String encryptedRequest){
       ...
       return new STFMP_Request(protocolVersion,action,params);
    }
}
